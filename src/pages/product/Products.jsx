...
export default function Products() {
  ...
  const editProduct = async (product) => {
    ...
    data.append(
      "activeStatus",
      product.activeStatus == "Active" ? "InActive" : "Active"
    );
    // activeStatus == "Active"
  ...
  return (
    <div>
        ...
        >
          <div className="flex justify-between flex-wrap gap-4 px-2 items-center w-full">
            ...
            <div className="pr-3 flex gap-2 items-center">
              ...
              <FaFileExcel
                className="text-[#217346] text-[24px] cursor-pointer"
                  ...
                  {products == false ? (
                    ...
                    products.map((product, index) => (
                      ...
                      >
                        ...
                        <td className="text-center min-w-[120px] border p-2">
                          {" "}
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        <td className="text-center min-w-[120px] border">
                          <p className="flex gap-3 w-full justify-center">
                            ...
                            <MdOutlineModeEdit
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/manage-product` , {state : {product }});
                              }}
                            />
                            <RiDeleteBin6Line
      ...
      <div className="z-50 absolute -left-[500%]">
        <h1>Quotation</h1>
